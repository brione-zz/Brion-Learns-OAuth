...
public class BLOA extends ListActivity implements OnClickListener {
	...
	private class MyArrayAdapter extends ArrayAdapter<UserStatus> {
		...
		public View getView(int pos, View reUse, ViewGroup parent) {
			...
			holder.text1.setText(us.getUserName());
	...
	private JSONObject authenticatedQuery(DefaultHttpClient client, String url) {
		JSONObject jso = null;
	...
	private class GetCredentialsTask extends AsyncTask<Void, Void, JSONObject> {
		...
		protected JSONObject doInBackground(Void... arg0) {
			JSONObject jso = null;
			try {
				jso = authenticatedQuery(mClient, VERIFY_URL_STRING);
	...
	private class UserStatus {
		...
		public String getText() {
			return mStatus.optString("text", "Bad Value");
		}
		public Time getDateTime() {
			Time ret1 = new Time();
			Time ret2 = new Time();
			Time ret3 = new Time();
			boolean b1 = ret1.parse(mStatus.optString("created_at", "Bad Value"));
			boolean b2 = ret2.parse(mStatus.optString("created_at", "Bad Value"));
			boolean b3 = ret3.parse(mStatus.optString("created_at", "Bad Value"));
			return ret1;
		}
	}
